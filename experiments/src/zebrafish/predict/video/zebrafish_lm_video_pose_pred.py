...
model = YOLO("/experiments/zebrafish/lm_19_m_w_fliplr_800/weights/best.pt")
# model = YOLO("/home/wangshuo/Code/SIMIT/Research/Petra/ultralytics/runs/pose/train3/weights/best.pt")
model.to(device)

# source = "/home/wangshuo/Datasets/SIMIT/AnimalPoseBehavior/zebrafish_lm/yolo_type_dataset/images/test"
